...
export default function Intro() {
  ...
  return (
    ...
    <div  ref = {ref} className="z-[10] flex flex-col  lg:flex-row  relative w-[100%]  scroll-mt-[10rem] lg:mt-[1rem] mt-[6rem]" id  = "Home">
       
      <motion.div className="about_me top-[50px] relative px-10 lg:w-[50%] lg:top-[10rem] flex flex-col  left-[0] lg:left-0 ">

       <div className="flex justify-center items-center md:max-w-[50%] m-auto ">
