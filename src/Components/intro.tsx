  ...
  return (
    ...
    <div  ref = {ref} className="flex flex-col  lg:flex-row  relative w-[100%]  scroll-mt-[10rem] lg:mt-[1rem] mt-[6rem]" id  = "Home">
      ...
      <div className="mt-[40px] flex lg:flex-row flex-col gap-2  lg:m-auto ">
        ...
        <a href="https://www.linkedin.com/in/chukwuemeka-paul-aggiah-571993110/" target = "_blank" className="active:scale-105 hover:scale-105 w-1/2 ml-[10px] bg-white text-stone-800 rounded-full px-[10px] h-[40px] text-[1rem] font-bold py-[5px] hover:bg-transparent hover:border-2 hover:border-black hover:text-black transition-all  "><BsLinkedin className="mt-[6px] items-center ml-[50%] lg:ml-[5%] " /></a>
       ...
       <motion.div className="relative top-[6rem] flex px-10  lg:flex-row flex-col-reverse gap-y-12  " >
       
      <div className="w-full max-w-screen-sm lg:max-w-screen relative lg:absolute top-[2rem] lg:top-[3rem] ">
          ...
          <div className="flex  relative left-[20px] lg:translate-x-[150%] top-8 md:m-auto  ">
